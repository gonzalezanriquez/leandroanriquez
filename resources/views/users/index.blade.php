                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        ...
                                        <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div
                                                ...
                                                <h2 class="text-sm font-normal">  {{ $user->lastname }}</h2>
                                            </div>
                                        </td>
                                        <td
                                            ...
                                            <div class="flex items-center gap-x-6">
                                                <a href="{{ route('user.edit', ['id' => $user->id]) }}">
                                                    ...
                                                    <form action="{{ route('users.destroy', ['user' => $user->id]) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button onclick="openModal()" class="text-gray-500 transition-colors duration-200 dark:hover:text-red-500 dark:text-gray-300 hover:text-red-500 focus:outline-none"type=submit>
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                                class="w-5 h-5">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <button onclick="openModal()" class="whitespace-nowrap rounded-md bg-red-500 px-4 py-3 font-medium text-white">Eliminar Usuario</button>
