<x-app-layout>
    ...
    <section class="container px-4 mx-auto">
        ...
        <div class="flex items-center gap-x-3">
            {{-- ICONO --}}
            <x-heroicon-o-academic-cap class="w-6 h-6 text-gray-500"/>
            <h2 class="text-lg font-medium text-gray-800 dark:text-white tracking-wider hidden md:table-cell">Estudiantes
            </h2>
            {{-- TITULO --}}
            <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">{{ $estudiantes->count() }} Estudiantes</span>
        </div>
            {{-- TABLA --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div
                                                ...
                                                <h2 class="text-sm font-normal text-emerald-500">  {{ $data->roles }}</h2>
                                            </div>
                                        </td>
                                        <td
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div class="flex items-center gap-x-6">
                                                <a href="{{ route('estudiante.edit', ['id' => $data->id]) }}"><button
                                                ...
                                                <a href="/estudiante/edit/{{ $user->id }}"><button
                                                        class="text-gray-500 transition-colors duration-200 dark:hover:text-red-500 dark:text-gray-300 hover:text-red-500 focus:outline-none">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                            class="w-5 h-5">
