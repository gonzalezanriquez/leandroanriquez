...
<div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 my-5 text-center">
  <div class="grid gap-4 md:gap-8 xl:gap-20 items-center">
    <div>
      <h1 class="block text-2xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
        Soluciones Integrales para tus <span class="text-amber-400">gestiones escolares</span>
      </h1>
      <p class="mt-5 text-lg text-gray-800 dark:text-neutral-400">
        Te ayudamos a sistematizar todas tus labores administrativas escolares brindando una respuesta rápida y sencilla a docentes, alumnos y personal escolar.
      </p>

      <div class="mt-10 grid gap-3 w-full justify-center">
        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg  bg-red-800 text-white hover:bg-red-700 focus:outline-none focus:bg-red-900 disabled:opacity-50 disabled:pointer-events-none" href="{{route('login')}}">
          Iniciar Sesion         
        </a>
